...
public class GameController {
	...
	public void initialize() {
		...
		storeAvailableCells(PlayerType.PLAYER_ONE, othelloGame.getGameBoard()
				.getGameBoardObjectiveIndexes(getStateBaseObjective(getBoardCellState(PlayerType.PLAYER_ONE))), false);
		storeAvailableCells(PlayerType.PLAYER_TWO, othelloGame.getGameBoard()
				.getGameBoardObjectiveIndexes(getStateBaseObjective(getBoardCellState(PlayerType.PLAYER_TWO))), false);
	...
	public void makeMove(PlayerType player, int row, int col, boolean initialStateMove) {
		...
		case PLAYER_ONE:
			...
			storeAvailableCells(PlayerType.PLAYER_TWO, othelloGame.getGameBoard().getGameBoardObjectiveIndexes(
					getStateBaseObjective(getBoardCellState(PlayerType.PLAYER_TWO))), false);
		...
		case PLAYER_TWO:
			...
			storeAvailableCells(PlayerType.PLAYER_ONE, othelloGame.getGameBoard().getGameBoardObjectiveIndexes(
					getStateBaseObjective(getBoardCellState(PlayerType.PLAYER_ONE))), false);
	...
	public void computeAvailableMoves(PlayerType player, BoardCellState state) {
		...
		for (GameBoardCell cell : cells) {
			...
			for (ObjectiveWrapper availableCell : availableCells) {
				...
				othelloGame.getGameBoard().getGameBoardCell(index).setObjective(getStateBaseObjective(state),
						buildTrail(availableCell));
				...
				Othello.print(" Path Color: "
						+ othelloGame.getGameBoard().getGameBoardCell(availableCell.getPath().get(0).getIndex()));
